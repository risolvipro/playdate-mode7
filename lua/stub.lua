...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-getSize
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-getMainDisplay
---@return mode7.display
function mode7.world:getMainDisplay() return {} end

--- Sets a bitmap for the plane.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-setPlaneBitmap
---@param bitmap mode7.bitmap
function mode7.world:setPlaneBitmap(bitmap) end

--- Returns the plane bitmap.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-getPlaneBitmap
---@return mode7.bitmap
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-worldToDisplayPoint
---@param x number
---@param y number
---@param z number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-displayToPlanePoint
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-displayMultiplierForScanlineAt
---@param x number
---@param y number
---@param z number
---@param display mode7.display?
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-planeToBitmapPoint
---@param planeX number
---@param planeY number
...
--- Returns a bitmap point from a plane point. If the world scale is 1, the two points are equal.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-bitmapToPlanePoint
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-addDisplay
---@param display mode7.display
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-addSprite
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-update
function mode7.world:update() end

--- Draws the contents of the world for the given display.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-draw
---@param display mode7.display?
function mode7.world:draw(display) end

--- Returns a mode7.array (not a Lua array) of all sprites added to world.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-getSprites
---@return mode7.array
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-world-getVisibleSpriteInstances
---@param display mode7.display?
---@return mode7.array
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-new
---@param x integer
---@param y integer
---@param width integer
---@param height integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-setRect
---@param x integer
---@param y integer
---@param width integer
---@param height integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-getRect
---@return integer x
---@return integer y
---@return integer width
---@return integer height
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-setCamera
---@return integer x
---@return integer y
---@return integer width
---@return integer height
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-getCamera
---@return mode7.camera
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-setScale
---@param scale integer
function mode7.display:setScale(scale) end

--- Gets the scale factor for the plane.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-getScale
---@return integer
function mode7.display:getScale() return 0 end

--- Returns the background interface associated to the display.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-getBackground
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-getHorizon
---@return integer
function mode7.display:getHorizon() return 0 end

--- Returns the world associated to the display.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-getWorld
---@return mode7.world
function mode7.display:getWorld() return {} end

--- Removes the display from the world.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-display-removeFromWorld
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-background-setBitmap
---@param image mode7.image?
function mode7.background:setImage(image) end

--- Gets the background bitmap.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-background-getBitmap
---@return mode7.image?
function mode7.background:getImage() return {} end

--- Gets the background offset.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-background-getOffset
---@return number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-background-setRoundingIncrement
---@param x integer
---@param y integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-background-getRoundingIncrement
---@return number x
---@return number y
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-background-setCenter
---@param cx number
---@param cy number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-background-getCenter
---@return number x
---@return number y
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-bitmap-loadPGM
---@param path string
---@return mode7.bitmap
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-bitmap-getSize
---@return integer width
---@return integer height
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-pool-realloc
---@param size number
function mode7.pool.realloc(size) end

--- Clear the pool. You should call it before loading a new bitmap.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-pool-clear
function mode7.pool.clear() end

--- Creates a new camera.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-new
---@return mode7.camera
function mode7.camera.new() return {} end

--- Sets the camera position.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-setPosition
---@param x number
---@param y number
---@param z number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-getPosition
---@return number x
---@return number y
---@return number z
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-setAngle
---@param angle number
function mode7.camera:setAngle(angle) end

--- Gets the camera yaw angle.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-getAngle
---@return number
function mode7.camera:getAngle() return 0 end

--- Sets the camera pitch angle.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-setPitch
---@param pitch number
function mode7.camera:setPitch(pitch) end

--- Gets the camera pitch angle.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-getPitch
---@return number
function mode7.camera:getPitch() return 0 end

--- Sets the camera FOV angle.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-setFOV
---@param fov number
function mode7.camera:setFOV(fov) end

--- Gets the camera FOV angle.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-getFOV
---@return number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-setClipDistanceUnits
---@param units integer
function mode7.camera:setClipDistanceUnits(units) end

--- Gets the camera clip distance units.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-getClipDistanceUnits
---@return number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-camera-lookAtPoint
---@param x number
---@param y number
---@param z number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-new
---@param width number
---@param height number
---@param depth number
---@return mode7.sprite
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-getInstance
---@param display mode7.display?
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setPosition
---@param x number
---@param y number
---@param z number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-getPosition
---@return number x
---@return number y
---@return number z
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setSize
---@param width number
---@param height number
---@param depth number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-getSize
---@return number width
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setAngle
---@param angle number
function mode7.sprite:setAngle(angle) end

--- Gets the sprite yaw angle.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-getAngle
---@return number angle
function mode7.sprite:getAngle() return 0 end

--- Sets the sprite pitch angle.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setPitch
---@param pitch number
function mode7.sprite:setPitch(pitch) end

--- Gets the sprite pitch angle.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-getPitch
---@return number pitch
function mode7.sprite:getPitch() return 0 end

--- Sets the sprite frame index (all instances).
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setFrame
---@param frame number
function mode7.sprite:setFrame(frame) end

--- Sets the sprite visibility for all the instances.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setVisible
---@param visible boolean
function mode7.sprite:setVisible(visible) end

--- Sets the image center for all the instances.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setImageCenter
---@param cx number
---@param cy number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setRoundingIncrement
---@param x integer
---@param y integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setAlignment
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setBimapTable
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-setDrawFunction
---@param functionName string
function mode7.sprite:setDrawFunctionName(functionName) end

--- Gets the sprite data source interface.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-datasource-setMaximumWidth
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-datasource-setMinimumWidth
---@param width integer
function mode7.sprite.datasource:setMinimumWidth(width) end

--- Sets the length for the given data source key (all instances).
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-datasource-setLengthForKey
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-datasource-setLayout
---@param k1 integer
---@param k2 integer
---@param k3 integer
---@param k4 integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-getWorld
---@return mode7.world?
function mode7.sprite:getWorld() return {} end

--- Removes the sprite from the world.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-sprite-removeFromWorld
function mode7.sprite:removeFromWorld() end

--- Returns the sprite associated to the instance.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-spriteInstance
---@return mode7.sprite
function mode7.sprite.instance:getSprite() return {} end

--- Sets the visibility for the instance.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-setVisible
---@param visible boolean
function mode7.sprite.instance:setVisible(visible) end

--- Gets the visibility for the instance.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-isVisible
---@return boolean
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-setFrame
---@param frame number
function mode7.sprite.instance:setFrame(frame) end

--- Gets the sprite frame index for the instance.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-getFrame
---@return integer
function mode7.sprite.instance:getFrame() return 0 end

--- Gets the sprite center for the instance.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-getImageCenter
---@return number cx
---@return number cy
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-setImageCenter
---@param cx number
---@param cy number
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-setRoundingIncrement
---@param x integer
---@param y integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-getRoundingIncrement
---@return integer x
---@return integer y
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-setAlignment
---@param alignmentX integer
---@param alignmentY integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-getAlignment
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-setBitmapTable
---@param imageTable mode7.imagetable?
function mode7.sprite.instance:setImageTable(imageTable) end

--- Gets the image table for the instance.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-getBitmapTable
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-setDrawFunction
---@param name string
function mode7.sprite.instance:setDrawFunctionName(name) end

--- It returns the visible image for the instance.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-getImage
---@return mode7.image
function mode7.sprite.instance:getImage() return {} end

--- It returns the display rect for the instance.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-getDisplayRect
---@return integer x
---@return integer y
---@return integer width
---@return integer height
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-isVisibleOnDisplay
---@return boolean
function mode7.sprite.instance:isVisibleOnDisplay() return false end

--- Returns the data source of the instance.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteInstance-getDataSource
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteDataSource-setMaximumWidth
---@param width integer
function mode7.sprite.instance.datasource:setMaximumWidth(width) end

--- Gets the maximum width for the data source.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteDataSource-getMaximumWidth
---@return integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteDataSource-setMinimumWidth
---@param width integer
function mode7.sprite.instance.datasource:setMinimumWidth(width) end

--- Gets the minimum width for the data source.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteDataSource-getMinimumWidth
---@return integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteDataSource-setLengthForKey
---@param width integer
---@param key integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteDataSource-setLayout
---@param k1 integer
---@param k2 integer
---@param k3 integer
---@param k4 integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteDataSource-getLengthForKey
---@param key integer
---@return integer
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-spriteDataSource-getLayout
---@return integer k1
---@return integer k2
---@return integer k3
---@return integer k4
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-luaImage-new
---@param path string
---@return mode7.image?
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-luaImage-getPDImage
---@return any
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-luaImageTable-new
---@param path string
---@return mode7.imagetable?
...
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-luaArray-size
---@return integer
function mode7.array:size() return 0 end

--- Gets the item at the given index, array starts at index 1.
---
--- https://risolvipro.github.io/mode7-playdate/Lua-API.html#def-luaArray-get
---@param index integer
---@return any
